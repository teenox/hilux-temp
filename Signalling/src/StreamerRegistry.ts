...
export class StreamerRegistry extends EventEmitter {
    ...
    find(streamerId: string): IStreamer | undefined {
     ...
     findByRemoteAddress(remoteAddress: string | undefined): IStreamer | undefined {
        return this.streamers.find((streamer) => streamer.getStreamerInfo().remoteAddress === remoteAddress);
    }
